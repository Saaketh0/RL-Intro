...
- The ratio between the new and old ratios are initially 1, and diverge. If it goes under 1, that means the new policy is less likely to do that, and if above 1, it means more likely. When you multiply that value by the advantage, a positive ratio means that the action was good, and a negative means the action was bad. You want to decrease the ratio of negative actions and increase the ratio of good actions.
